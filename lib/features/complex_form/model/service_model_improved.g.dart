...
CapacidadInstalada _$CapacidadInstaladaFromJson(Map<String, dynamic> json) =>
    CapacidadInstalada(
      ...
      areaMetrosCuadrados:
          (json['area_metros_cuadrados'] as num?)?.toDouble(),
    );
...
Infraestructura _$InfraestructuraFromJson(Map<String, dynamic> json) =>
    Infraestructura(
      ...
      disposicionLocativa:
          json['disposicion_locativa'] as String? ?? 'primer_piso',
      tieneRetie: json['tiene_retie'] as bool? ?? false,
      areaTotalMetrosCuadrados:
          (json['area_total_metros_cuadrados'] as num?)?.toDouble(),
      fechaConstruccion: json['fecha_construccion'] == null
          ? null
          : DateTime.parse(json['fecha_construccion'] as String),
      capacidadInstalada: (json['capacidad_instalada'] as List<dynamic>?)
              ?.map(
                  (e) => CapacidadInstalada.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
    );
